...
- Si la taille n est pas multiple de `XX`, on ajoute du padding 0x00.
...
Si la taille n est pas multiple de `XX`, on ajoute des octets 0x00 pour
atteindre un multiple. Le nombre d octets ajoutes (`pad_len`) est stocke
en suffixe (1 octet) et n est pas encode.
